...
import { ArrowUpRight, ArrowDownLeft, DollarSign, Search, Filter } from "lucide-react"
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <p className="text-sm text-gray-600">Complete record of all your investment transactions</p>
      </CardHeader>
      <CardContent>
        {/* Filters */}
