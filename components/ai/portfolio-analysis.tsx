      ...
      <CardContent>
        <div className="space-y-6">
          ...
          <div className="text-center p-4 bg-gray-50 rounded-lg">
            ...
            <p className="text-sm text-gray-600">Overall Portfolio Health Score</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center p-3 border rounded-lg">
              ...
              <div className={`text-xl font-bold ${getScoreColor(analysis.riskScore)}`}>{analysis.riskScore}</div>
            </div>
            <div className="text-center p-3 border rounded-lg">
              <div className="flex items-center justify-center gap-1 mb-2">
              ...
              <div className={`text-xl font-bold ${getScoreColor(analysis.diversificationScore)}`}>
            ...
            <div className="text-center p-3 border rounded-lg">
              ...
              <div className={`text-xl font-bold ${getScoreColor(analysis.performanceScore)}`}>
          ...
          <div className="space-y-4">
            <h3 className="font-medium text-gray-900">Detailed Insights</h3>
            {analysis.insights.map((insight, index) => (
              <div key={index} className="p-4 border rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <Badge className={getScoreBadgeColor(insight.score)}>{insight.score}/100</Badge>
                </div>
